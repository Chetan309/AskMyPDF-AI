                    ...
                    <div className="rounded-2xl border border-gray-200 p-6 shadow-xs sm:px-8 lg:p-12">
                        <div className="text-center">
                            ...
                            <p className="mt-2 sm:mt-4">
                                <strong className="text-3xl font-bold text-gray-900 sm:text-4xl"> 3$ </strong>
                        ...
                        <ul className="mt-6 space-y-2">
                            <li className="flex items-center gap-1">
                                <svg className="size-5 text-indigo-700 shadow-sm" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
        ...
        Get Started
                        ...
                        <div className="mt-5">
                            {!getUserInfo?.upgrade ? (
                                ...
                                <div className="mt-8 block rounded-full border border-blue-600 bg-blue-600 px-12 py-3 text-center text-sm font-medium text-white hover:ring-1 hover:ring-blue-600 focus:ring-4 focus:outline-hidden">
                                    Current Plan
                                </div>
                            )}
                        </div>
                    ...
                    <div className="rounded-2xl p-6 shadow-md border sm:order-first sm:px-8 lg:p-12">
                        ...
                        <ul className="mt-6 space-y-2">
                            <li className="flex items-center gap-1">
                                <svg className="size-5 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                                </svg>
