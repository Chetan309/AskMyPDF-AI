        ...
        <div className="bg-gradient-to-r from-gray-100 to-blue-200 min-h-screen">
            ...
            <Link href={"/"}>
                ...
                <div className="space-x-6">
                    <Button
                        className="ml-4 rounded-full bg-black hover:bg-gray-700"
            ...
            <section className="text-center py-20 px-6 mt-[2rem]">
                ...
                <span className="text-black"> Simplify </span> <span className="text-red-500">PDF</span>{" "}
                    <span className="text-blue-500">Note</span><span className="text-black">-Taking With </span>
